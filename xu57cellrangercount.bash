...
######################
##Job name
#SBATCH -J xu57cellrangercount.bash
# Standard out and Standard Error output files with the job number in the name.
#SBATCH -o logs/xu57cellrangercount.bash_res.txt
#SBATCH -e logs/xu57cellrangercount.bash_err.txt
...
cellranger count --id=xu57CountOut \
 --fastqs=/share/xulab/AN00019900_raw_data_matrix/xu57/ \
 --sample=XU57 \
