...
######################
##Job name
#SBATCH -J str29map.bash
# Standard out and Standard Error output files with the job number in the name.
#SBATCH -o logs/str29map.bash_res.txt
#SBATCH -e logs/str29map.bash_err.txt
...
STAR --runThreadN 8 \
 ...
 --readFilesIn /share/xulab/seanr/strAnalyz/xu29/xx29_S1_L001_R2_001.fastq.gz /share/xulab/seanr/strAnalyz/xu29/xx29_S1_L001_R1_001.fastq.gz \
