...
######################
##Job name
#SBATCH -J xu53cellrangercount.bash
# Standard out and Standard Error output files with the job number in the name.
#SBATCH -o logs/xu53cellrangercount.bash_res.txt
#SBATCH -e logs/xu53cellrangercount.bash_err.txt
...
cellranger count --id=xu53CountOut \
 --fastqs=/share/xulab/AN00019900_raw_data_matrix/xu53/ \
 --sample=XU53 \
