...
######################
##Job name
#SBATCH -J xu51cellrangercount.bash
# Standard out and Standard Error output files with the job number in the name.
#SBATCH -o logs/xu51cellrangercount.bash_res.txt
#SBATCH -e logs/xu51cellrangercount.bash_err.txt
...
cellranger count --id=xu51CountOut \
 --fastqs=/share/xulab/AN00019900_raw_data_matrix/xu51/ \
 --sample=XU51 \
