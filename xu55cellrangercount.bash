...
######################
##Job name
#SBATCH -J xu55cellrangercount.bash
# Standard out and Standard Error output files with the job number in the name.
#SBATCH -o logs/xu55cellrangercount.bash_res.txt
#SBATCH -e logs/xu55cellrangercount.bash_err.txt
...
cellranger count --id=xu55CountOut \
 --fastqs=/share/xulab/AN00019900_raw_data_matrix/xu55/ \
 --sample=XU55 \
