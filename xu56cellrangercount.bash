...
######################
##Job name
#SBATCH -J xu56cellrangercount.bash
# Standard out and Standard Error output files with the job number in the name.
#SBATCH -o logs/xu56cellrangercount.bash_res.txt
#SBATCH -e logs/xu56cellrangercount.bash_err.txt
...
cellranger count --id=xu56CountOut \
 --fastqs=/share/xulab/AN00019900_raw_data_matrix/xu56/ \
 --sample=XU56 \
