...
######################
##Job name
#SBATCH -J xu58cellrangercount.bash
# Standard out and Standard Error output files with the job number in the name.
#SBATCH -o logs/xu58cellrangercount.bash_res.txt
#SBATCH -e logs/xu58cellrangercount.bash_err.txt
...
cellranger count --id=xu58CountOut \
 --fastqs=/share/xulab/AN00019900_raw_data_matrix/xu58/ \
 --sample=XU58 \
